...
const SelectProducts =  ({products, selectedProduct, setSelectedProduct, toggleModal}) => {
    ...
    function renderItem(product) {
        ...
        <div class="productSearchItem" data-name={`${product.title} ${product.id}`} style={{borderBottom:'1px solid #e1e3e5'}}>
            <ResourceItem id={product.id}>       
                <ProductSearchItem  toggleModal={toggleModal} setSelectedProduct={setSelectedProduct} product={product} selectedProduct={selectedProduct}></ProductSearchItem>      
            </ResourceItem>
        </div>
        );
    }
